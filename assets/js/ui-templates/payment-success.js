...
(function(templates) {
    ...
    templates.PaymentSuccess = function() {
      return `
        <div id='payment-success'>
          <img src='${templates.getImageUrl('success_circle_icon')}' alt='Success circle icon'/>
          <div>
              <p class='side-note'>You have paid <span id='currency'></span> <span id='total-amount'></span> to <span id='store-name'>Systems Limited</span>.</p>
