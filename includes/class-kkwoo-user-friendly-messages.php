<?php
/**
 *  User friendly display messages class.
 *
...
/**
 * Handles generating and managing messages
 * displayed to users during payment and checkout flows, including
 * success, error, and informational messages.
 */
class KKWoo_User_Friendly_Messages {

	/**
	 * User-friendly messages used throughout the plugin.
	 *
	 * Contains predefined success, error, and informational
	 * messages displayed to users during payment flows.
	 *
	 * @var array<string, string>
	 */
	public static $user_friendly_messages = array(
		...
		'till_number_missing'                     => 'The till number is required. Update the Kopo Kopo for WooCommerce settings',
	...
	/**
	 * Returns the actual message based on the message identifier passed.
	 *
