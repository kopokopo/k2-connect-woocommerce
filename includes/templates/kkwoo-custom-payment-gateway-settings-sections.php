<?php
/**
 * Custom section added to the Kopo Kopo for WooCommerce plugin settings page.
 *
 * The template Adds two buttons to Create Webhook subscriptions and Refresh access token.
 *
